...
class VID_Trans(nn.Module):
    def __init__(self, num_classes, camera_num, pretrainpath, frame_num=6):
        super(VID_Trans, self).__init__()
        self.in_planes = 768
        self.num_classes = num_classes
        self.frame_dim = frame_num * self.in_planes
...
#         self.block1 = Block(
#             dim=self.frame_dim, num_heads=12, mlp_ratio=4, qkv_bias=True, qk_scale=None,
#             drop=0, attn_drop=0, drop_path=dpr[11], norm_layer=partial(nn.LayerNorm, eps=1e-6))

#         self.b2 = nn.Sequential(
#             self.block1,
#             nn.LayerNorm(self.frame_dim)  #copy.deepcopy(layer_norm)
#         )

#         self.bottleneck_1 = nn.BatchNorm1d(self.frame_dim)
#         self.bottleneck_1.bias.requires_grad_(False)
#         self.bottleneck_1.apply(weights_init_kaiming)
#         self.bottleneck_2 = nn.BatchNorm1d(self.frame_dim)
#         self.bottleneck_2.bias.requires_grad_(False)
#         self.bottleneck_2.apply(weights_init_kaiming)
#         self.bottleneck_3 = nn.BatchNorm1d(self.frame_dim)
#         self.bottleneck_3.bias.requires_grad_(False)
#         self.bottleneck_3.apply(weights_init_kaiming)
#         self.bottleneck_4 = nn.BatchNorm1d(self.frame_dim)
#         self.bottleneck_4.bias.requires_grad_(False)
#         self.bottleneck_4.apply(weights_init_kaiming)

#         self.classifier_1 = nn.Linear(self.frame_dim, self.num_classes, bias=False)
#         self.classifier_1.apply(weights_init_classifier)
#         self.classifier_2 = nn.Linear(self.frame_dim, self.num_classes, bias=False)
#         self.classifier_2.apply(weights_init_classifier)
#         self.classifier_3 = nn.Linear(self.frame_dim, self.num_classes, bias=False)
#         self.classifier_3.apply(weights_init_classifier)
#         self.classifier_4 = nn.Linear(self.frame_dim, self.num_classes, bias=False)
    ...
    def forward(self, x, y=None, cam_label=None, view_label=None):  # label is unused if self.cos_layer == 'no'
        b = x.size(0)
        t = x.size(1)
        ...
        # features, cross_video, self_video, audio = self.base(x, y, cam_label=cam_label)
        features, cross_video, _, _ = self.base(x, y, cam_label=cam_label)
...
#         part4_bn = self.bottleneck_4(part4_f)
        ...
        if self.training:
            ...
            return Global_ID, global_feat  #[global_feat, part1_f, part2_f, part3_f,part4_f],  a_vals
            # return Global_ID, global_feat  #[global_feat, part1_f, part2_f, part3_f,part4_f],  a_vals
            # return [Global_ID, Local_ID1, Local_ID2, Local_ID3, Local_ID4 ], [global_feat, part1_f, part2_f, part3_f,part4_f]
        else:
            return Global_ID, global_feat, cross_video
