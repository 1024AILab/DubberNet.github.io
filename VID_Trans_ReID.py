...
if __name__ == '__main__':
    ...
    sys.stdout = Logger(os.path.join('/root/VID-MSE/log-teacher-w_timeblock_res', 'prid_train.txt'))
    ...
    for epoch in range(1, epochs + 1):
        ...
        for Epoch_n, (img, audios, pid, target_cam, labels2) in enumerate(train_loader):
            ...
            with amp.autocast(enabled=True):
                ...
                # score, feat, a_vals= model(img, y=audios, cam_label=target_cam)
                
                score, feat = model(img, y=audios, cam_label=target_cam)
                ...
                loss_id = loss_fun(score, feat, pid, target_cam)
                # loss=loss_id + attn_loss
                loss=loss_id
        ...
        if (epoch+1) % 30 == 0 :
               ...
               if cmc_rank1 < cmc:
                  cmc_rank1=cmc
                  torch.save(model.state_dict(),os.path.join('/root/VID-MSE/log-teacher-w_timeblock_res',  Dataset_name+'Main_Model.pth')) 
